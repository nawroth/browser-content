...
__The Movie Graph__ is a mini graph application containing actors and
...
* http://neo4j.com/docs/%7B%7Bneo4j.version%20%7C%20neo4jdoc%20%7D%7D/query-match.html#match-variable-length-relationships[variable
length relationships]
* http://neo4j.com/docs/%7B%7Bneo4j.version%20%7C%20neo4jdoc%20%7D%7D/query-match.html#match-shortest-path[shortestPath]
...
1.  Find actors that Tom Hanks hasn't yet worked with, but his co-actors
have.
...
Extend Tom Hanks co-actors, to find co-co-actors who haven't work with
Tom Hanks...
